...
import { inputBlog } from "../actions/blog.action";
      ...
      <Col className="box-login" md={6} xs={12}>
        ...
        <Formik
          ...
          onSubmit={(values, { setSubmitting }) => {
            ...
            this.props.inputBlog(formData, this.props.history);
          }}
        >
          {({
            values,
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    inputBlog: (values, history) => {
      dispatch(inputBlog(values, history));
    }
  };
};

// export default connect(null, mapDispatchToProps)(Register);
export default withRouter(connect(null, mapDispatchToProps)(InputBlog));
